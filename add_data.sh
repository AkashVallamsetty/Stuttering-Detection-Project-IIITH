#!/bin/bash
# add questions
http POST localhost:5000/question question="ನಿಮ್ಮ ಹೆಸರು ಏನು ?" bound=10
http POST localhost:5000/question question="ನೀವು ಎಲ್ಲಿ ವಾಸ ಮಾಡುತ್ತಿದ್ದೀರಾ ?" bound=17
http POST localhost:5000/question question="ನಿಮ್ಮ ಮನೆಯಲ್ಲಿ ಯಾರೆಲ್ಲ ಇದ್ದಾರೆ ?" bound=22
http POST localhost:5000/question question="ನೀವು ಏನು ಓದುತ್ತಿದ್ದೀರಾ/ ಕೆಲಸ ಮಾಡುತ್ತಿದ್ದೀರಾ?" bound=18
http POST localhost:5000/question question="ನಿಮ್ಮ ಹವ್ಯಾಸಗಳು ಏನು?" bound=15
