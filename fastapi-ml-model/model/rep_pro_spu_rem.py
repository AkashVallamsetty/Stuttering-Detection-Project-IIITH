...
# def removing_blocks(original_array,pks_val,valley_ind_vals):
#   print("Entered blocking")
#   final_valley_points=[]
#   final_pks_points=[]
#   index_list=[]
#   for k in range(len(valley_ind_vals)):
...
#     try:
#         diff=np.abs(original_array[pks_val[i+1]]-original_array[pks_val[i]])
#       # print("values in bb",original_array[valley_ind_vals[i]],"index value in bb",valley_ind_vals[i])
#         print("values in bb",original_array[pks_val[i+1]],"index value in bb",original_array[pks_val[i]])
#         if diff>0.6:
#           # valley_ind_vals.pop(i+1)
#           final_valley_points.pop(i)
#           final_pks_points.pop(i)
#           index_list.append(i)
#           # print("removed index bb",valley_ind_vals[i+1],"value",original_array[valley_ind_vals[i+1]])
#         else:
#           continue
...
def for_block1(original_array,pks_val,valley_ind_vals):
  final_valley_points=[]
  final_pks_points=[]
  index_list=[]
  for k in range(len(valley_ind_vals)):
...
def for_prolongation3(original_array,pks_val,valley_ind_vals):
  final_valley_points=[]
  final_pks_points=[]
  index_list=[]
  for k in range(len(valley_ind_vals)):
  ...
  for i in range(nl):
    ...
    try:
      ...
      diff=np.abs(original_array[pks_val[i]]-original_array[pks_val[i+1]])
      # print("index value",pks_val[i],"index value +1",pks_val[i+1],"diff",diff)
      diff_time=np.abs(valley_ind_vals[i]-valley_ind_vals[i+1])
      diff_time=round(diff_time,3)
      if diff<0.020 and diff_time in [100,200]:
